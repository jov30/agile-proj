...
FeaturePageContext = dict[str, Any]


FEATURE_PAGES: dict[str, FeaturePageContext] = {
    "login": {
        "title": "Login",
...
def get_feature_page_context(feature_key: str) -> FeaturePageContext:
    return FEATURE_PAGES[feature_key]
