...
ITEM_SOURCES: Dict[str, Dict[str, object]] = {
    ...
    "Bun Bo Hue Cup": {"queries": ["bun bo hue", "spicy noodle soup bowl"]},
    ...
    "Pork Sizzling Hot Plate": {"queries": ["pork skillet"]},
    "Tofu Sizzling Hot Plate": {"queries": ["tofu sizzling plate"]},
